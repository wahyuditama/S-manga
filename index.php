...
<body>
  ...
  <div class="container p-3 mb-0 mt-4 rounded-3 shadow">
    ...
    <nav class="d-md-flex p-4">
      <div>
        <h1 style="color: dark">Website SManga</h1>
      </div>
      <div class="ms-auto my-auto">
        <ul class="list-inline m-0">
          ...
          <li class="list-inline-item mx-md-2"><a href="#contact" class="text-decoration-none text-dark fw-bold">Login</a></li>
        </ul>
      </div>
    </nav>
    <hr>
    ...
    <div class="card-title border-bottom border-primary-subtle m-2 p-2 shadow-md" align="right">
      ...
      <?php else : ?>
        <a href="?tambah=<?php echo $modalDisplay['id'] ?>" class="text-decoration-none btn btn-sm btn-danger">Tambah Banner</a>
      <?php endif ?>
    </div>
    ...
    <?php else : ?>
      ...
      <!-- copyright/copas -->
      <!-- <div class="text-center p-4 border-top">&copy; 2023 . - Iseng-Iseng Bikin</div>
    </div> -->
  </div>
  <div class="bg-light text-center p-0">
    <div class=" mx-auto w-75">
      <h6 class="text-center p-2 border-top font-weight-bold">&copy; 2023 . - Iseng-Iseng Bikin
      </h6>
    </div>
  </div>
    ...
    <div class="modal fade" id="exampleModal<?php echo $modalDisplay['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
                      ...
                      <div class="accordion-body">
                        <strong>
                          ...
                          <?php else : ?>
                            ...
                            <a href="?change=<?php echo $modalDisplay['id_detail'] ?>" class="btn btn-sm btn-success mx-3" data-toggle="tooltip" data-placement="top" data-bs-custom-class="custom-tooltip" title="Edit Chapter"><i class='bx bx-pencil'></i></a>
                            <a href="?add_data" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" data-bs-custom-class="custom-tooltip" title="Tambah Chapter"><i class='bx bx-message-square-add'></i></a>
                          <?php endif ?>
                        </strong>
                      </div>
                    </div>
          ...
          <div class="card-title mt-2 border shadow-sm p-2">
            <span class="fw-900"><i>Customize Banner</i></span>
          </div>
          <div class="modal-footer d-flex justify-content-between">
            <div class="d-flex mx-2">
              <a href="?edit=<?php echo $modalDisplay['id'] ?>" class="btn btn-sm btn-success mx-3" data-toggle="tooltip" data-placement="top" data-bs-custom-class="custom-tooltip" title="Edit Banner">Edit</a>
            </div>
